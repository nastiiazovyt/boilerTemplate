...
var arrowOnHoverMenu = function arrowOnHoverMenu() {
...
var arrowOutHoverMenu = function arrowOutHoverMenu() {
...
gsap__WEBPACK_IMPORTED_MODULE_0__["default"].registerPlugin(gsap_ScrollToPlugin__WEBPACK_IMPORTED_MODULE_1__["default"]); //________________________________________________________________________
...
window.addEventListener('scroll', headerScale); //________________________________________________________________________
//Анимация плавного появления хедера

var headerOpacity = function headerOpacity() {
  var header = document.querySelector('header');
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].fromTo(header, {
    opacity: 0
  }, {
    opacity: 1,
    duration: 1
...
window.addEventListener('load', headerOpacity); //________________________________________________________________________
//Анимация стрелочек на ховере кнопки
...
buttonHeader.addEventListener('mouseout', arrowOutHoverHeader); //________________________________________________________________________
//Анимация при клике на ссылки в хедере

var menuButton = document.querySelector('.menu-link');
var eventButton = document.querySelector('.event-link');
var contactsButton = document.querySelector('.contacts-link');
...
var heroAnimation = function heroAnimation() {
  ...
  if (document.querySelector('.hero-title')) {
    ...
    var heroTitleArray = document.querySelectorAll('.hero-title .char');
    gsap__WEBPACK_IMPORTED_MODULE_1__["default"].fromTo(heroTitleArray, {
      yPercent: 100
    }, {
      yPercent: 0,
      stagger: {
...
var arrowOnHoverHero = function arrowOnHoverHero() {
  svg1.classList.add('svg-hover1');
  svg2.classList.add('svg-hover2');
  svg1.classList.remove('svg-not-hover1');
  svg2.classList.remove('svg-not-hover2');
...
var arrowOutHoverHero = function arrowOutHoverHero() {
  svg1.classList.remove('svg-hover1');
  svg2.classList.remove('svg-hover2');
  svg1.classList.add('svg-not-hover1');
  svg2.classList.add('svg-not-hover2');
...
var infoScrollAnimation = function infoScrollAnimation() {
  var info = document.querySelector('.info');
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].fromTo(info, {
    y: 15,
    opacity: 0
  }, {
    y: 0,
    ...
    duration: .8,
    scrollTrigger: {
      trigger: info // start: 'center bottom-=100px',
...
var menuSlides = document.querySelectorAll('.menu-section');
menuSlides.forEach(function (slider) {
  var menuSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper', {
...
document.addEventListener('DOMContentLoaded', function (event) {
  __webpack_require__(/*! ../../../../src/js/pages/menu-swiper */ "./src/js/pages/menu-swiper.js");

  __webpack_require__(/*! ../../../../src/js/pages/header */ "./src/js/pages/header.js");

  __webpack_require__(/*! ../../../../src/js/pages/hero */ "./src/js/pages/hero.js");

  __webpack_require__(/*! ../../../../src/js/pages/menu */ "./src/js/pages/menu.js");

  __webpack_require__(/*! ../../../../src/js/pages/info */ "./src/js/pages/info.js");

  __webpack_require__(/*! ../../../../src/js/pages/events */ "./src/js/pages/events.js");

  __webpack_require__(/*! ../../../../src/js/pages/footer */ "./src/js/pages/footer.js");
});
}();
/******/ })()
;